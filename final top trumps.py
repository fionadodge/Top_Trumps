...
def run():
    ...
    if stat_choice == 'species':
        if my_stat == 'human' and opponents_stat == 'human':
            print('You are both human, you draw! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            ...
            print('You lose! You are a Human and your opponent is a extremely large and hairy Humanoid. Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!'.format(opponents_stat))
            opponents_score = opponents_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'human' and opponents_stat == 'centaur':
            print('You lose! Your opponent wins! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!'.format(opponents_stat))
            opponents_score = opponents_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'human' and opponents_stat == 'cat':
            print('You win, your opponent loses! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            my_score = my_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'human' and opponents_stat == 'werewolf':
            print('You lose, your opponent wins! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            opponents_score = opponents_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
            ...
            print('You lose! You are an extremely large Humanoid, and your opponent is Human. Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            opponents_score = opponents_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'half-giant' and opponents_stat == 'ghost':
            print('You win! You are an extremely large Humanoid, and your opponent is a Ghost. Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            my_score = my_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'half-giant' and opponents_stat == 'centaur':
            print('You win because centaurs are wise and peaceful! Your opponent wins! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            my_score = my_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        elif my_stat == 'half-giant' and opponents_stat == 'cat':
            print('You win as an extremely large Humanoid! Your opponent wins! Newt Scamander helped to develop this game, creatures and Fantastic Beasts win!')
            my_score = my_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
    ...
    if stat_choice == 'house':
        if my_stat == 'Gryffindor':
            if opponents_stat == 'Slytherin':
                print('You win! Slytherin lose. Gryffindor won the House Cup last year.'.format(my_stat, opponents_stat))
                my_score = my_score + 1
                print('Your score is ', my_score)
                print('Your opponents score is ', opponents_score)
            elif opponents_stat == 'Hufflepuff':
                print('You win! Hufflepuff lose. Gryffindor won the House Cup last year.'.format(my_stat, opponents_stat))
                my_score = my_score + 1
                print('Your score is ', my_score)
                print('Your opponents score is ', opponents_score)
        ...
        if my_stat == 'Slytherin':
            if opponents_stat == 'Ravenclaw':
                ...
                print('You lose! Your opponent wins! Gryffindor won the House Cup last year.'.format(my_stat, opponents_stat))
                opponents_score = opponents_score + 1
                print('Your score is ', my_score)
                print('Your opponents score is ', opponents_score)
                ...
                print('We could not find a House and the Sorting Hat is on Annual Leave, please play again.')
        if my_stat == 'Hufflepuff':
            if opponents_stat == 'Gryffindor':
                ...
                print('Draw! You both lose! You are both from Hufflepuff. Gryffindor won the House Cup last year.'.format(my_stat, opponents_stat))
                print('Your score is still {}', my_score)
                print('Your opponents score is still {}', opponents_score)
            else:
                print('We could not find a House and the Sorting Hat is on Annual Leave, please play again.')
        if my_stat == 'Ravenclaw':
            if opponents_stat == 'Gryffindor':
                ...
                print('You Draw! You are both from Ravenclaw. Gryffindor won the House Cup last year.'.format(my_stat, opponents_stat))
                print('Your score is still {}', my_score)
                print('Your opponents score is still {}', opponents_score)
            else:
                print('We could not find a House and the Sorting Hat is on Annual Leave, please play again.')
    ...
    if stat_choice == 'student':
        if my_stat and opponents_stat == True:
            ...
            print('You win! You are a member of staff.'.format(my_stat, opponents_stat))
            my_score = my_score + 1
            print('Your score is ', my_score)
            print('Your opponents score is ', opponents_score)
        else:
